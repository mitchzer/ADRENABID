...
bid1 = Bid.create!(price: "130", won: 0, auction: auction1, user: user1)
...
bid5 = Bid.create!(price: "0", won: 0, auction: auction2, user: user2)
bid6 = Bid.create!(price: "0", won: 0, auction: auction1, user: user3)
bid7 = Bid.create!(price: "0", won: 0, auction: auction1, user: user3)
bid8 = Bid.create!(price: "120", won: 0, auction: auction1, user: user2)
bid9 = Bid.create!(price: "120", won: 0, auction: auction1, user: user1)
bid10 = Bid.create!(price: "300", won: 0, auction: auction1, user: user2)
bid11 = Bid.create!(price: "300", won: 0, auction: auction1, user: user3)
bid12 = Bid.create!(price: "200", won: 0, auction: auction1, user: user2)
